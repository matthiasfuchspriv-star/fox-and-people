      ...
      <div className="flex-1 bg-bg rounded-t-[22px] px-6 pt-7 pb-10 shadow-[0_-12px_40px_rgba(0,0,0,.25)]">
        {!codeSchritt ? (
          <form action={codeAnfordern} className="space-y-4">
            ...
            <input name="eingabe" required autoFocus inputMode="email" autoComplete="username" placeholder="E-Mail-Adresse" className="input !py-3 !text-[16px] !rounded-[11px]" defaultValue={sp.e ?? ""} />
          ...
          <form action={codePruefen} className="space-y-4">
            ...
            <input name="code" required autoFocus inputMode="numeric" pattern="[0-9]{6}" maxLength={6} autoComplete="one-time-code" placeholder="123456" className="input !py-3 !text-[24px] !rounded-[11px] text-center tracking-[0.4em] num" />
