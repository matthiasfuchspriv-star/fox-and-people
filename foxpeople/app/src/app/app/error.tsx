  ...
  return (
    <main className="min-h-screen bg-bg flex items-center justify-center px-6 max-w-lg mx-auto">
      <div className="text-center">
        ...
        <h1 className="font-display font-extrabold text-[21px] mb-2">Das hat gerade nicht geklappt</h1>
        ...
        <a href="/app" className="block text-[13px] text-brand font-semibold mt-4">Zur Startseite</a>
      </div>
    </main>
  );
}
