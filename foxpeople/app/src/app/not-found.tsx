...
export default function NichtGefunden() {
  return (
    <main className="min-h-screen flex items-center justify-center px-6 bg-brand-ink">
      <div className="text-center text-white max-w-sm">
        <div className="text-[12.5px] tracking-[2px] opacity-60 mb-2">FOX &amp; PEOPLE</div>
        <h1 className="font-display font-extrabold text-[22px] mb-2">Diese Seite gibt es nicht</h1>
        <p className="text-[15px] opacity-80 mb-5">Vielleicht ist der Link veraltet oder etwas abgeschnitten. Beides passiert – wir helfen gern weiter.</p>
